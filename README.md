# comaprison of performance and dedtailed analysis of 3 models: xgboost, NN-UTA-DIS, and regular NN on german risk datast.

all .ipynb files are the project codebase + report each file contains a separate project part:
